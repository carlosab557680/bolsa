...
if (isset($_POST['btnEntrar'])) {
    ...
    $arrayRaPendenciaFinanceira = array(
        "470.230.708-85", "478.603.348-01", "478.153.898-30", "503.753.568-94", "444.449.294-07", "446.450.358-60",
        "424.665.238-50", "460.455.408-08", "470.923.478-74", "459.469.758-54", "457.081.088-86", "362.087.628-20",
        "389.088.928-00", "449.242.808-95", "062.585.013-03", "486.081.188-74", "451.543.558-22", "446.463.478-81",
        "456.785.058-07", "476.124.988-98", "472.657.718-26", "497.346.888-63", "450.986.128-10", "457.766.628-69",
        "440.745.708-23", "480.693.858-04", "490.335.358-31", "491.145.888-70", "489.509.838-93", "490.885.468-86",
        "451.019.378-51", "475.277.158-63", "413.297.578-90", "134.747.267-30", "469.373.388-13", "472.125.748-13",
        "496.335.448-90", "473.002.978-03", "394.514.558-92", "410.287.828-96", "457.375.088-62", "454.939.828-03",
        "450.896.818-05", "463.099.218-94", "443.378.908-90", "503.010.428-37", "432.077.758-10");
    ...
    $arrayRaCalouro100 = array(
        "461.216.778-30", "519.810.058-70", "497.399.688-21", "455.547.088-54", "496.955.948-16", "506.979.758-19",
        "504.135.648-35", "429.195.908-71", "486.463.528-54", "486.463.328-29", "436.760.868-99", "511.777.828-63",
        "462.581.658-00", "538.672.778-85", "498.929.778-40", "515.228.788-90", "486.504.408-60", "430.660.248-65",
        "373.632.528-23", "463.437.248-77", "487.565.688-27", "457.348.228-84", "488.211.028-82", "237.721.538-60",
        "395.020.758-97", "489.767.458-17", "524.363.138-81", "443.486.598-69", "475.396.998-33", "490.479.318-82",
        "445.662.548-10", "477.795.758-61", "504.376.548-85", "506.311.168-85", "459.753.238-27", "334.346.018-48",
        "452.414.058-10", "484.340.998-70", "445.662.218-06", "440.339.938-00", "511.973.398-09", "512.084.728-52",
        "125.496.564-58", "473.640.588-00", "460.568.958-31", "396.907.738-95", "460.158.408-62", "505.630.598-77",
        "444.816.748-81", "446.679.398-00", "374.051.598-85", "511.702.608-02", "525.114.018-51", "144.773.468-83",
        "378.011.318-00", "510.348.538-99", "514.562.458-13", "461.600.678-42", "531.956.438-47", "429.639.028-75",
        "438.329.728-54", "463.565.758-24", "509.848.278-03", "484.626.138-76", "458.997.988-82", "446.271.568-39",
        "230.492.928-14", "527.144.098-22", "518.597.458-30", "422.614.048-67", "512.049.878-74", "431.317.108-88",
        "506.189.588-60", "438.485.638-51", "518.248.028-89");
    ...
    $arrayRaCalouro50 = array(
        "451.662.058-80", "508.157.568-19", "491.314.548-79", "424.060.508-31", "448.574.418-37", "503.382.878-92",
        "468.848.528-01", "448.151.228-81", "468.613.548-64", "515.355.508-99");
                    ...
                    if ($c = getContempladoByStatus($lc, contemplado::STATUS_AGUARDANDO)) {
                        ...
                        if ($a->select()) {
                            ...
                            if(strpos($a->getEmail(), '@li.facens.br')){
                                ...
                                $bkver = $a->getValorprincipal();

                                ///if($ra == '235789' || $ra == '235465' || $ra = '235068'){
                                   /// if ($a->getValorprincipal() == '') { 
							    // verificar essas linha comentadas - Carlos
                                        if ($a->getErro() == '') {
                                           if ($a->getCpf() == $cpf) {
                                                ...
                                                require_once './layout/grid/bolsas.grid.php';
                                            } else {
                                             $msg = "O CPF não confere com esse RA.";
                                             require_once './layout/form/home.form.php';
                                            }
                                        } else {
                                            $msg = "Aluno não matriculado no atual período letivo 1."; //////////////////////////////////// aqui está o breakpoint
                                            require_once './layout/form/home.form.php';
                                        }
                                   //} else {
                                  //     $msg = "Aluno não matriculado no atual período letivo xxxxxx.";
                                   //    require_once './layout/form/home.form.php';
                                   //}
                                    ...
                                    if ($a->getValorprincipal() != '') { 
                                        ...
                                        if ($a->getErro() == '') {
                                           if ($a->getCpf() == $cpf) {
                                            ...
                                            $msg = "Aluno não matriculado no atual período letivo 3.";
                                            require_once './layout/form/home.form.php';
                                        }
                                   } else {
                                       $msg = "Aluno não matriculado no atual período letivo 4."; // aqui está o breakpoint
                                       require_once './layout/form/home.form.php';
                                   }
                                }
                                */
                               ...
                               if ($a->getValorprincipal() != '') { 
                                    ...
                                    if ($a->getErro() == '') {
                                       if ($a->getCpf() == $cpf) {
                                        ...
                                        $msg = "Aluno não matriculado no atual período letivo."; //////////////////////////////////// aqui está o breakpoint
                                        require_once './layout/form/home.form.php';
                                    }
                               } else {
