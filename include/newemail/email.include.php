...
function enviaEmail($dest, $assunto, $corpoHtml, $corpoText = '') {
    ...
    //c//$mail->SMTPSecure = "starttls"; //Tipo de criptografia
	...
	//$mail->AddAddress('carlos.barbosa@facens.br');
	$mail->AddAddress('carlosaugusto.b@gmail.com');
