...
<div class="principal">
    ...
    <div class="pagina1">
        ...
        <p>
            2) Período de concessão: <b>de <?php echo strftime("%B", strtotime($contrato->getDtinicio())) ?> a <?php echo strftime("%B", strtotime($contrato->getDtfim())) ?> de <?php echo strftime("%Y", strtotime($contrato->getDtfim())) ?>.</b>
        </p>
        <p>
    ...
    <div class="pagina2">
        ...
        <ol>
            <li>A Monitoria Acadêmica deverá ser desenvolvida nos meses de março a junho de 2016 em conformidade
            ...
            <li>O horário da monitoria, estipulado pela FACENS, será:
                <ul>
                    <li>
                        <b>Período da manhã:</b> de segunda a sexta, das 11h20 às 12h50.
                    </li>
                    <li>
                        <b>Período da noite:</b> de segunda a sexta, das 17h20 às 18h50.
                    </li>
                    ...
                    Além das horas descritas acima, os monitores poderão ser convocados para atividades no sábado e em outros períodos em que ocorram eventos na faculdade.</li>
            </ul><br>
            </li>
            ...
            <li>Pelas atividades de monitoria, o aluno monitor fará jus a uma bolsa de 30% do valor das mensalidades de abril, maio, junho e julho de 2016.<br><br></li>
