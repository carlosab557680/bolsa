    ...
    <div class="pagina1">
        ...
        <table class="table-bolsa">
            <thead>
                ...
                <tr style="text-align: left;">
                    <td><b><?php echo $a->getNome() ?></b>, brasileiro(a), portador(a) do RG n.º <?php echo $a->getRg() ?> e do CPF/MF n.º <?php echo $a->getCpf() ?>, <b>RA <?php echo $a->getRa() ?></b>, 
        ...
        <p>
            I - O CONTRATANTE manifesta neste ato a opção de realizar matrícula sob as condições do 
                FINANCIAMENTO  ESTUDANTIL  (FIES), bem  como declara possuir todas as condições para 
                obtenção do financiamento.
        </p>
        <p>
            II - O CONTRATANTE deverá realizar todos os procedimento necessários para a obtenção do 
                financiamento,  especialmente  a  comprovação  perante  a  CONTRATADA,  de  acordo  com  as 
                normas vigentes do FIES e suas respectivas datas limites para cada ato do procedimento. 
        </p>
        <p>
