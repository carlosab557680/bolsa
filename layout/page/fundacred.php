...
<div class="principal">
    ...
    <div class="pagina1">
        ...
        <h3><u>registrado sob o n° 192.754 em 20/12/2021 </u></h3>
            ...
            <thead>
                ...
                <tr style="text-align: left;">
                    <td>ACRTS – Associação Cultural de Renovação Tecnológica Sorocabana, 
                        devidamente inscrita no CNPJ/MF sob o nº 45.718.988/0001-67, entidade mantenedora do 
                        Centro Universitário FACENS, com endereço  na Rodovia  Senador José Ermírio de Moraes, nº 
                ...
                <tr style="text-align: left;">
                    <td><b><?php echo $a->getNome() ?></b>, brasileiro(a), portador(a) do  RG n.º <?php echo $a->getRg() ?> CPF/MF N.º <?php echo $a->getCpf() ?>, <b>RA <?php echo $a->getRa() ?></b>, 
        ...
        <p style="text-indent: 4em;">
            ...
            ADITAR o Contrato de Prestação de Serviços Educacionais registrado sob o nº  192.754 em 
            20/12/2021, conforme segue:
        </p>
        <p>
            I - O CONTRATANTE manifesta neste ato a opção de realizar matrícula sob as condições do financiamento pela <b>FUNDAÇÃO DE CRÉDITO EDUCATIVO (FUNDACRED)</b>, bem como declara possuir todas as condições para obtenção do financiamento.
        </p>
        <p>
            II - O CONTRATANTE deverá realizar todos os procedimentos necessários para obtenção do financiamento, especialmente a comprovação perante a CONTRATADA, de acordo com as normas vigentes da <b>FUNDACRED</b> e suas respectivas datas limites para cada ato do procedimento.
        </p>
        <p>
        ...
        <div class="invisible">
            ...
            <p>
                ...
                <b>Nome: Marlene Silveira da Rocha Arruda</b><br>
                <b>CPF: 518.870.379-34</b><br>
                <b>RG: 19.178.191-5</b>
            </p>
            <p>
                2-________________________________________<br>
                <b>Nome: Fabíola Regiane do Nascimento</b><br>
